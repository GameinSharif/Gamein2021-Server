...
public class ProviderController
{
    ...
    public void newProvider(ProcessedRequest processedRequest, NewProviderRequest newProviderRequest)
    {
        ...
        try {
            ...
            Integer minPrice = ReadJsonFilesManager.findProductById(newProviderRequest.getProductId()).getMinPrice();
            ...
            if (userTeam == null) {
                ...
                newProviderResponse = new NewProviderResponse(ResponseTypeConstant.NEW_PROVIDER, providerDto, "Provider Created!");
            }
    ...
    private boolean isInProductionLinesProducts(Team team, Integer productId) {
        ...
        for (ProductionLineDto productionLineDto : productionLines) {
            if (
                    productionLineDto.getProductionLineTemplateId().equals(product.getProductionLineTemplateId()) &&
